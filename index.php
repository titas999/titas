...
<div class="page-cover">
    <div class="cover-bg bg-img" data-image-src="<?php echo get_template_directory_uri(); ?>/assets/img/titas_twp.jpeg"></div>
...
<main class="page-main page-fullpage main-anim" id="mainpage">
                ...
                <div class="row">
                    <div class="col-12 col-md-12 text-center">
                        <div class="title-desc">
                            ...
                            <h4 class="anim-2 opacity-75">We are creative experts, build your company with us. Today’s
    ...
    <div class="section services section-list-feature fp-auto-height-responsive " data-section="services">
        <div class="section-wrapper twoside center-vh dir-col anim">
            <div class="anim-2 text-center mb-3">
                <h2 class="display-4 display-title">Services</h2>
                            ...
                            <div class="images text-center">
                                <div class="img-avatar-alpha">
                                    <div class="img-1 shadow">
                                        <a href="item.html">
                                            <img class="img" src="<?php echo get_template_directory_uri(); ?>/assets/img/team-1.jpg" alt="Image">
                                        </a>
                        ...
                        <div class="section-content anim">
                            <div class="images text-center">
                                <div class="img-avatar-alpha">
                                    <div class="img-1 shadow">
                                        <a href="item.html">
                                            <img class="img" src="<?php echo get_template_directory_uri(); ?>/assets/img/team-2.jpg" alt="Image">
                                        </a>
                                        <div class="legend pos-abs">
                                            <div class="text-left">
                                                <h5>Sara Eniston</h5>
                        ...
                        <div class="section-content anim translateDown">
                            <div class="images text-center">
                                <div class="img-avatar-alpha">
                                    <div class="img-1 shadow">
                                        <a href="item.html">
                                            <img class="img" src="<?php echo get_template_directory_uri(); ?>/assets/img/team-3.jpg" alt="Image">
                                        </a>
                                        <div class="legend pos-abs">
                                            <div class="text-left">
                                                <h5>James Duncan</h5>
                    ...
                    <ul class="item-list swiper-wrapper">
                        <li class="slide-item swiper-slide">
                            <div class="item-wrapper">
                                <div class="illustr">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/project-1.jpg" alt="Image" class="img">
                                </div>
                        ...
                        <li class="slide-item swiper-slide">
                            <div class="item-wrapper">
                                <div class="illustr">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/project-2.jpg" alt="Image" class="img">
                                </div>
                                <a class="legend" href="item.html#project_url">
                        ...
                        <li class="slide-item swiper-slide">
                            <div class="item-wrapper">
                                <div class="illustr">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/project-3.jpg" alt="Image" class="img">
                                </div>
                                <a class="legend" href="item.html#project_url">
                                ...
                                <div class="row">
                                    <div class="col col-12">
                                        <div class="media-image mb-3">
                                            <img class="logo" src="<?php echo get_template_directory_uri(); ?>/assets/img/client-1.jpg" alt="Alt Text">
                                        </div>
                                    </div>
                                    <div class="col col-12 m-auto">
                                        <div class="media-body">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Obcaecati
                                                eveniet porro tenetur
                                                omnis saepe vitae sapiente eum consectetur. Lorem ipsum dolor sit amet,
                                                consectetur
                                                adipisicing elit.</p>
                                            <h4 class="">July Stephan | VP President</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="media-slide-item-gamma">
                            <div class="media-content text-anim">
                                <div class="row">
                                    <div class="col col-12">
                                        <div class="media-image mb-3">
                                            <img class="logo" src="<?php echo get_template_directory_uri(); ?>/assets/img/client-2.jpg" alt="Alt Text">
                                        </div>
                                    </div>
                                    <div class="col col-12 m-auto">
                                        <div class="media-body">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Obcaecati
                                                ...
                                                consectetur
                                                adipisicing elit.</p>
                                            <h4 class="">Edmon Mariston | Co-Founder Labs</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="media-slide-item-gamma">
                            <div class="media-content text-anim">
                                <div class="row">
                                    <div class="col col-12">
                                        <div class="media-image mb-3">
                                            <img class="logo" src="<?php echo get_template_directory_uri(); ?>/assets/img/client-3.jpg" alt="Alt Text">
                                        </div>
                                    </div>
                                    <div class="col col-12 m-auto">
                                        <div class="media-body">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Obcaecati
                                                ...
                                                consectetur
                                                adipisicing elit.</p>
                                            <h4 class="">Lia Kart | CEO Startup-Land</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="section section-subscribe fp-auto-height-responsive fp-section anim fp-completely" data-section="register">
        <div class="section-wrapper center-vh dir-col">
            <div class="section-title text-center">
                <h2 class="display-4 display-title anim-2 mb-32">Newsletters</h2>
                <p class="invite anim-3 opacity-75">Be the first to hear about the latest releases.</p>
            </div>
            <div class="section-content reduced">
                <div class="row">
                    <div class="col-12 col-md-10 col-lg-10 anim-2 m-auto">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/subscrip-img.png" alt="">
                        <form class="send_email_form form-container form-content-transparent form-content-white" method="post" action="#">
                            <div class="form-input  anim-4">

                                <div class="form-group form-success-gone">
                                    <label for="reg-email">Email</label>
                                    <input id="reg-email" name="email" class="form-control-line form-control-white" type="email" required data-validation-type="email" />
                                </div>
                                <div class="form-group mb-0 text-center">
                                    <div>
                                        <p class="email-ok invisible form-text-feedback form-success-visible">Your email
                                            has been registred, thank you.</p>
                                    </div>
                                    <button id="submit-email" class="btn btn-outline-white form-success-gone" name="submit_email">Subscribe
                                    </button>
                                </div>
                            </div>
                        </form>
    ...
    <div class="section section-contact fp-auto-height-responsive no-slide-arrows " data-section="contact">
        <div class="section-wrapper center-vh dir-col anim">
            <div class="section-title text-center">
                ...
                <p>Need Help? Don't Forget to Contact With Me</p>
            </div>
            <div class="section-content reduced">
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-7 text-left contact-left">
                        <form class="send_message_form message form" method="post" action="#" id="message_form">
                            ...
                            <div class="form-group no-border">
                                ...
                                <textarea id="mes-text" name="message" class="form-control form-control-outline thick form-success-clean" required></textarea>
                                <div>
                                    <p class="message-ok invisible form-text-feedback form-success-visible">Your message
                                        has been sent, thank you.</p>
                                </div>
                            </div>
                            <div class="btns">
                                <button id="submit-message" class="btn btn-outline-white btn-full email_b" name="submit_message">
                    ...
                    <div class="col-12 col-md-12 col-lg-5 text-left contact-right">
                        ...
                        <div>
                            <h4>Email</h4>
                            <p>info@anisuzzaman.me</p>
                            <p>support@anisuzzaman.me</p>
                        </div>
                    </div>
                </div>
            </div>
